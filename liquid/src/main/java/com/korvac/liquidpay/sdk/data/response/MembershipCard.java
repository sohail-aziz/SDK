...
@AutoParcelGson
public abstract class MembershipCard implements Parcelable {
    ...
    public static MembershipCard create(String type, String id, String name, String imageUrl, String status, String baseCurrency,
                                        ...
                                        String startAt, String endAt, String createdAt) {

        return new AutoParcelGson_MembershipCard(type, id, name, imageUrl, status, baseCurrency, discountCardType, factor,
                factorType, roundType, infoMsg, promoMsg, termsAndCOnditions, startAt, endAt, createdAt);
    }
}
